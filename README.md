...
(https://skillicons.dev/icons?i=html,css,js,php,git,github,laravel,symfony,react,vue&perline=10)](https://skillicons.dev)

(https://skillicons.dev/icons?i=mysql,mongodb,postgresql,java,python,androidstudio,tailwindcss,bootstrap,pinia,unity&perline=10)](https://skillicons.dev)

(https://skillicons.dev/icons?i=c,c#,cpp,figma,vscode,npm,linux,sass,node,vite,electron&perline=10)](https://skillicons.dev)
